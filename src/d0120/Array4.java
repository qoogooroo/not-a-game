...
public class Array4 {
	...
	public static void main(String[] args) {
		...
		/*
		 * for(int i= 0; i<strs.length; i++) { strs[i] = i+1+""; }
		 * 
		 * 
		 * for(int i= 0; i<strs.length; i++) { if ((i+1) % 10 != 0) {
		 * System.out.print(", "); } else { System.out.println(); } if((i+1)<10 &&
		 * (i+1)%10!=3) { System.out.print(strs[i]); } }
		 */
